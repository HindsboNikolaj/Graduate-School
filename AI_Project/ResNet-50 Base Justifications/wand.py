...
def train(model = None,
    ...
    if train_size != 1.0:
        train_dataset, _ = train_test_split(train_dataset, test_size = (1 - train_size))

    new_train_len = len(train_dataset)

    print("train portion ", train_size, "\n old size: ", train_len, "\n New Size: ", new_train_len)
